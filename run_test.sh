...
node server_capacity.js --use_logs=true --num_users=[NUM-OF-USERS] --test_duration=[TEST-DURATION] --room_group_name="[ROOM-GROUP-NAME]" --num_rooms=[NUM-OF-ROOMS] --delay_between_participants=[DELAY-BETWEEN-PARTICIPANTS] --delay_to_enter_room=[DELAY-TO-ENTER-ROOM];
'
